$(function() {
  ...
  var createSpinner = function(container, labelText, options) {
    var label = $('<p>' + (labelText || 'Loading') + '</p>');
  ...
  ajaxForms.live('submit', function(evt) {
    ...
    $.ajax(ajaxURL, {
      ...
      error: function(jqXHR, textStatus, errorThrown) {
        ...
        $(document.body).prepend(errorAlertHTML);
  ...
  // Setup spinners.
  var spinners = $('div.spinner');
  
  spinners.each(function(idx, spinnerContainer) {
    createSpinner($(spinnerContainer));
  });
